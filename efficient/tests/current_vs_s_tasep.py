...
def run_test():
    ...
    return slope
    fig1.savefig('results/test/varyS_CGF.pdf')
    fig2.savefig('results/test/varyS_scaledCGF.pdf')
    fig3.savefig('results/test/varyS_current.pdf')
    fig4.savefig('results/test/varyS_scaledCurrent.pdf')
    fig5.savefig('results/test/varyS_entanglementEntropy.pdf')
