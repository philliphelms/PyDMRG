...
if len(sVec) == 1:
    ...
    ax = fig.gca()
    sm,pm = np.meshgrid(sVec,pVec)
    surf = ax.pcolormesh(sm,pm,np.log(np.real(gap_ed)),cmap=colormap)
    ax.set_ylim(0,1)
    ax.set_xlim(-5,5)
    fig.colorbar(surf)
    ...
    ax = fig.gca()
    sm,pm = np.meshgrid(sVec,pVec)
    surf = ax.pcolormesh(sm,pm,np.real(rightEE_ed),cmap=colormap)
    ax.set_ylim(0,1)
    ax.set_xlim(-5,5)
    fig.colorbar(surf)
    ...
    ax = fig.gca()
    sm,pm = np.meshgrid(sVec,pVec)
    surf = ax.pcolormesh(sm,pm,np.real(leftEE_ed),cmap=colormap)
    ax.set_ylim(0,1)
    ax.set_xlim(-5,5)
    fig.colorbar(surf)
